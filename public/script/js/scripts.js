...
$(function() {
    ...
    rotateH1();
    (new ScrollScene({
        triggerElement: "#introduce .mainPicture",
        triggerHook: 0,
        duration: 5
    })).addTo($controller).on("start", function(b) {
        "FORWARD" == b.scrollDirection && (animate_illustration("illustration_introduce", "start"), subnav($(".btn-menu"), "out", $liHeightMenu))
    }).on("end", function(b) {
        "REVERSE" == b.scrollDirection && (animate_illustration("illustration_introduce", "end"), animate_illustration("illustration_portfolio", "end"), animate_illustration("illustration_contact", "end"), $increment = 0, setTimeout(function() {
                // $("#awards .counter").html("-")
            },
            300))
    });
    ...
    })).addTo($controller).setTween(TweenMax.fromTo("#introduce .mainPicture", 1, {
    ...
    categorizr.isDesktop && (new ScrollScene({
        triggerElement: "#introduce .mainPicture > .fadeMainPicture",
        triggerHook: 0,
        duration: $(window).height()
    })).addTo($controller).setTween(TweenMax.to("#introduce .mainPicture > .fadeMainPicture",
        1, {
            opacity: .4
        }));
    (new ScrollScene({
    ...
    (new ScrollScene({
        ...
        triggerHook: 0,
        duration: $("#portfolio .mainPicture").height() / 4
    })).addTo($controller).on("start", function(b) {
        "FORWARD" == b.scrollDirection && animate_illustration("illustration_portfolio",
            "start")
    });
    (new ScrollScene({
        triggerElement: "#portfolio .mainPicture > .fadeMainPicture",
        triggerHook: 0,
        duration: $(window).height()
    })).addTo($controller).setTween(TweenMax.to("#portfolio .mainPicture > .fadeMainPicture", 1, {
        opacity: .4
    }));
    ...
    })).addTo($controller).setTween(TweenMax.fromTo("#portfolio .mainPicture", 1, {
    ...
    if ($("#portfolio-details").length) {
        ...
        $("#portfolio .prow").on($mouseEventClick, function() {
            ...
            categorizr.isDesktop ? $("html, body").animate({
                scrollTop: parseInt($("#portfolio").position().top + $posYportfolio - 200)
        ...
        "FORWARD" == b.scrollDirection && animate_illustration("illustration_contact", "start")
    });
    categorizr.isDesktop && (new ScrollScene({
    ...
    $(".social-icons").on("mouseenter", "a", function() {
        ...
        $("#contact .texte2 .w990px span").eq(_index).animate({
            opacity: 1
    ...
    $(".social-icons").on("mouseleave", "a", function() {
        $("#contact .texte2 .w990px span").animate({
            opacity: 0
        }, 200)
    });
